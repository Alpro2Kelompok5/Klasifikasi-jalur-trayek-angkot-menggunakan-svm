...
try:
    ...
    traceback.print_exc() # Menambahkan traceback untuk detail error
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename) and loaded_svm_model:
            try:
                ...
                traceback.print_exc() # This will print the full error details to the terminal
                return jsonify({'error': f'Terjadi error internal saat memproses gambar.'}), 500
